...
export default function DigitalTwinMap({
  ...
  return (
    <div ref={containerRef} className="digital-twin-container" style={{ position: 'relative', width: '100%', height: '100%', minHeight: '560px' }}>
      ...
      {/* 1. MAP VIEW MODE SWITCHER & QUICK SHORTEST ROUTE PRESETS BAR */}
      <div style={{
        position: 'absolute',
        top: '16px',
        left: '16px',
        ...
        {/* Left: View Mode Toggle (Google Map vs 2D/3D Digital Twin Canvas) */}
        <div style={{
          ...
          <button
            ...
            style={{
              background: viewMode === 'google' ? 'linear-gradient(135deg, #0066FF 0%, #00F0FF 100%)' : 'transparent',
              color: '#FFF',
              border: 'none',
              borderRadius: '12px',
              padding: '8px 16px',
              ...
              gap: '8px',
              cursor: 'pointer',
              boxShadow: viewMode === 'google' ? '0 0 15px rgba(0, 240, 255, 0.4)' : 'none'
            }}
          >
            <Map size={16} />
          ...
          <button
            ...
            style={{
              background: viewMode === 'twin' ? 'linear-gradient(135deg, #0066FF 0%, #00F0FF 100%)' : 'transparent',
              color: '#FFF',
              border: 'none',
              borderRadius: '12px',
              padding: '8px 16px',
              ...
              gap: '8px',
              cursor: 'pointer',
              boxShadow: viewMode === 'twin' ? '0 0 15px rgba(0, 240, 255, 0.4)' : 'none'
            }}
          >
            <Activity size={16} />
            <span>Digital Twin Canvas</span>
          </button>
        </div>

        {/* Right: Quick Shortest Route Presets ("Gate to Auditorium") */}
        <div style={{
          background: 'rgba(14, 23, 38, 0.85)',
          backdropFilter: 'blur(16px)',
          ...
          <span style={{ fontSize: '11px', fontWeight: 800, color: 'var(--color-cyan)', textTransform: 'uppercase' }}>
            ⚡ Shortest Route:
          </span>

          <button
            onClick={() => handleSelectPresetRoute('loc_auditorium_building')}
            style={{
              background: destination?.id === 'loc_auditorium_building' ? 'rgba(0, 240, 255, 0.25)' : 'rgba(255, 255, 255, 0.06)',
              border: '1px solid var(--border-glass-light)',
              color: '#FFF',
              padding: '6px 12px',
              borderRadius: '10px',
          ...
          <button
            onClick={() => handleSelectPresetRoute('bld_uiet')}
            style={{
              background: destination?.id === 'bld_uiet' ? 'rgba(0, 240, 255, 0.25)' : 'rgba(255, 255, 255, 0.06)',
              border: '1px solid var(--border-glass-light)',
              color: '#FFF',
              padding: '6px 12px',
              borderRadius: '10px',
          ...
          <button
            onClick={() => handleSelectPresetRoute('bld_library')}
            style={{
              background: destination?.id === 'bld_library' ? 'rgba(0, 240, 255, 0.25)' : 'rgba(255, 255, 255, 0.06)',
              border: '1px solid var(--border-glass-light)',
              color: '#FFF',
              padding: '6px 12px',
              borderRadius: '10px',
          ...
          <button
            onClick={() => handleSelectPresetRoute('loc_senate_hall')}
            style={{
              background: destination?.id === 'loc_senate_hall' ? 'rgba(0, 240, 255, 0.25)' : 'rgba(255, 255, 255, 0.06)',
              border: '1px solid var(--border-glass-light)',
              color: '#FFF',
              padding: '6px 12px',
              borderRadius: '10px',
